              ...
              <div className="bg-blue-50 rounded-lg p-5 border-2 border-blue-200">
                <div className="space-y-3">
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      <h3 className="font-bold text-gray-900 mb-1">基本サービス（現在）</h3>
                  ...
                  <div className="bg-white rounded p-3">
                    ...
                    <div className="bg-amber-50 border-l-2 border-amber-400 p-2 rounded">
                      <p className="text-xs text-amber-900 font-semibold mb-1">料金変更の可能性について</p>
                      <p className="text-xs text-amber-800 leading-relaxed">
                        将来的に有料プランを導入する可能性があります。有料化を行う場合は、実施の30日前までにウェブサイト上で告知いたします。既存利用者には移行期間を設けます。
                      </p>
                    </div>
                  </div>
                </div>
