          ...
          <div className="prose max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                本規約は、株式情報分析サービス（以下「当サービス」といいます）の利用に関する条件を、当サービスを利用する全ての方（以下「利用者」といいます）と株式会社アドバンス（以下「当社」といいます）との間で定めるものです。
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                当サービスは、株式市場の情報を分析し、利用者に提供する情報提供サービスです。
              </p>
              <p className="text-gray-700 leading-relaxed mb-3">
                当サービスは以下の機能を提供します：
              </p>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-gray-900 mb-4">第3条（サービス利用料金）</h2>
              <div className="bg-blue-50 border-l-4 border-blue-500 p-4 mb-4">
                <p className="text-gray-800 font-semibold mb-2">現在の料金体系</p>
                <p className="text-gray-700 leading-relaxed mb-3">
                  当サービスは現在、基本機能を無料で提供しております。ただし、将来的に有料プランを導入する可能性があります。
                </p>
              </div>
              <p className="text-gray-700 leading-relaxed mb-3">
                有料プランを導入する場合は、事前に当サービス上で告知いたします。既存の利用者については、有料化の30日前までに通知を行います。
              </p>
              <p className="text-gray-700 leading-relaxed">
                有料プランが導入された場合でも、基本的な情報閲覧機能については無料で提供し続ける可能性がありますが、当社の判断により変更される場合があります。
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-xl font-bold text-gray-900 mb-4">第4条（利用上の注意事項）</h2>
